  ...
  return (
      <div className='tracking-[-1.3]'>
          ...
          <div className='grid grid-cols-2 gap-4 items-center mt-6'>
              <Button className='h-full rounded-2xl bg-white border hover:scale-[1.02] hover:border-[#b0323a]/40 text-[#717272] border-[#717272]/60 font-[poppins] text-base font-medium' onClick={onClose}>Cancel</Button>
