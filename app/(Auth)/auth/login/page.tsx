...
function LoginContent() {
  ...
  return (
    <div className="w-full max-w-lg">
      ...
      <AuthWrapper>
        <h1 className="text-2xl font-semibold text-foreground tracking-[-1.5] mb-4 text-center">Welcome Back</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Submit Button */}
          <GradientButton btnText={isPending ? "Logging in..." : "Log in"} borderColor="#213670" disabled={isPending} />
        </form>
        ...
        <p className="text-center text-[#3754A3] text-base mt-6 font-semibold tracking-[-1] underline underline-offset-3 hover:text-[#2148A2] transition-colors duration-300">
          <Link href="/auth/signup">Don't have an account? Become a reporter</Link>
        </p>
      </AuthWrapper>
    </div>
  )
