  ...
  useEffect(() => {
    ...
    if (existingData?.id && !formData?.id) {
      ...
      setFormData(prev => ({
        ...prev,
        id: existingData.id,
        fullName: prev?.fullName || existingData?.full_name || existingData?.fullName || "",
        email: prev?.email || existingData?.email || "",
        role: prev?.role || existingData?.role || "",
        phone: prev?.phone || existingData?.phone_number || existingData?.phone || "",
      }));
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            {isDraftLoading ? "Loading your workspace setup..." : "Preparing your data..."}
          </p>
        </div>
      </div>
    );
